...
bool verifica(int f[], int v1, int v2, int contV){
    ...
    // if(f[0 * contV + v1]!=0 && f[0 *contV + v2]!=0){
    //     return false;
    // }
    return r;
}
...
int main(){
    ...
    int fimA = 1;
    int nivelF = 1;
    floresta[arestas[0][1]]= nivelF;
    floresta[arestas[0][2]]= nivelF;
    for(int i = 1; i < contA && arvore[contV - 2][0] == 0; i++){
        ...
        if(r == true){
            ...
            floresta[arestas[i][1]*(contV + 1) + arestas[i][2]] = arestas[i][2];
            arvore[fimA][0] = arestas[i][0];
            arvore[fimA][1] = arestas[i][1];
            arvore[fimA][2] = arestas[i][2];
            floresta[0 * (contV + 1) + arestas[i][1]]=1;
            floresta[0 * (contV + 1) + arestas[i][2]]=1;
            //j = 1;
            //while(floresta[arestas[i][2]*(contV + 1) + j] != 0){j++;}
            floresta[arestas[i][2]*(contV + 1) + arestas[i][1]] = arestas[i][1];
